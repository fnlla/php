...
- keep `section`, `container`, `card`, grid and related FNLLA UI layout conventions
...
2. Confirm FNLLA UI is synced and valid.
...
10. Run tests, lint and FNLLA UI validation before shipping.
  ...
  <div class="container">
    <div class="stack gap-lg">
      <header class="stack gap-sm">
        <h1>Services</h1>
        <p class="content-text">Build the page with FNLLA UI primitives and plain PHP data output.</p>
      </header>
...
- keep markup aligned with FNLLA UI classes and layout patterns
...
- compose layouts with FNLLA UI primitives first
...
- use FNLLA UI for layout, spacing, cards, grid, buttons, alerts and shells
...
6. Build views using FNLLA UI structure.
...
- UI work inside the FNLLA UI contract
