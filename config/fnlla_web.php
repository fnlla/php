...
return [
    ...
    "auto_sync" => (bool) env("FNLLA_WEB_AUTO_SYNC", $isDevelopmentLike),
    "check_interval_seconds" => max(0, (int) env("FNLLA_WEB_SYNC_INTERVAL_SECONDS", 900)),
    "sync_script" => (string) env("FNLLA_WEB_SYNC_SCRIPT", "scripts/sync-fnlla-web.ps1"),
    "state_path" => storage_path((string) env("FNLLA_WEB_STATE_PATH", "framework/fnlla-web-guard.json")),
